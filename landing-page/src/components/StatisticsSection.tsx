    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="text-center mb-16 scroll-animate">
          <span className="inline-flex items-center gap-2 rounded-full border border-orange-500/30 bg-orange-500/10 px-4 py-1.5 text-sm font-semibold uppercase tracking-widest text-orange-400">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 mb-20">
          {stats.map((stat, index) => (
            <div
              key={stat.label}
              className="liquid-glass-dark-v2 p-8 text-center"
        ...
        <div ref={metricsRef} className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-white mb-6">Hiệu Suất Hệ Thống</h3>
            {metrics.slice(0, 2).map((metric, index) => (
              <div key={metric.label} className="scroll-animate" style={{ animationDelay: `${index * 150}ms` }}>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="font-bold text-orange-400">{metric.value} {metric.unit}</span>
                </div>
        ...
        <div className="mt-20 text-center">
          <div className="liquid-glass-dark-v2 inline-flex items-center gap-4 px-8 py-4">
            {/* Shimmer overlay */}
            <div className="shimmer" />
            ...
            <div className="flex -space-x-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 border-2 border-gray-900 flex items-center justify-center text-white text-xs font-bold"
                >
