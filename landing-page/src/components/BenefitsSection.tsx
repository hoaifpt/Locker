...
export default function BenefitsSection() {
  ...
  return (
    <section ref={sectionRef} id="benefits" className="relative py-24 overflow-hidden">
      {/* Background */}
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 text-white shadow-lg shadow-orange-500/40">
                      {benefit.icon}
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-black text-orange-500 bg-orange-100 px-3 py-1 rounded-full">
                        {benefit.improvement}
                      </span>
                    </div>
          ...
          {/* Right: Comparison */}
          <div className="liquid-glass-v2 p-8" style={{ animationDelay: '200ms' }}>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 pb-4 border-b border-gray-200">
                  <div className="text-left">
                    <span className="inline-flex items-center gap-2 text-sm font-bold text-gray-400 uppercase tracking-wider">
                  ...
                  <div className="text-right">
                    <span className="inline-flex items-center gap-2 text-sm font-bold text-orange-500 uppercase tracking-wider">
                      E-BOX
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {comparisonData.traditional.map((item, index) => (
                  <div key={index} className="grid grid-cols-2 gap-4 py-3 border-b border-gray-100 last:border-0">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-sm text-gray-800 font-medium">{comparisonData.ebox[index]}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { icon: '🏆', label: 'Top 10 Startup', sublabel: 'FPT Education 2025' },
            { icon: '⭐', label: '4.9/5 Rating', sublabel: 'Trên App Store' },
            { icon: '📱', label: '50K+ Downloads', sublabel: 'Toàn quốc' },
            { icon: '🤝', label: '10+ Đối tác', sublabel: 'Vận chuyển & F&B' },
          ].map((badge) => (
            <div
              key={badge.label}
              className="liquid-card text-center p-6"
            >
